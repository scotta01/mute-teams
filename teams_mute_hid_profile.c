#include "teams_mute_hid_profile.h"
#include "teams_mute_hid_service.h"

#include <furi.h>
#include <string.h> // memcpy, memset
#include <usb_hid.h> // HID report-map macros
#include <furi_hal_usb_hid.h> // HID_KEYBOARD_* usage codes
#include <furi_hal_version.h> // furi_hal_version_get_ble_mac / ..._local_device_name_ptr

// battery + device-info services are exposed to FAPs; only the HID service
// (vendored above) is not.
#include <services/dev_info_service.h>
#include <services/battery_service.h>

// BLE constants the GAP config needs.
#include <gap.h> // GapConfig, GapPairingPinCodeVerifyYesNo
#include <ble/core/ble_defs.h> // UUID_TYPE_16
#include <ble/core/ble_std.h> // GAP_APPEARANCE_KEYBOARD
